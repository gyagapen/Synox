...
<body>
    ...
    <tr>
        <td>    
            ...
            <asp:Button ID="ButtonEnAttente" runat="server" Text="En Attente" 
       ...
       <asp:ListView ID="ListViewSmsEnErreur" runat="server" 
         ...
         <ItemTemplate>
            <tr>
                ...
                <td><asp:Label ID="LabelStatutId" runat="server" Text='<%#Eval("SmsStatut.Nom") %>' ToolTip='<%#Eval("SmsStatut.Nom") %>'></asp:Label></td>
                <td><asp:Label ID="LabelProjet" ForeColor="Green" runat="server" Text='<%#Eval("Projet.Nom") %>'></asp:Label></td>
            </tr>
         </ItemTemplate>
        <EmptyDataTemplate>
    ...
    <div align="center" style="padding:10px; text-align:left;">        
       <asp:ListView ID="ListViewSmsEnvoyes" runat="server" 
         ...
         <ItemTemplate>
            <tr>
                <td><asp:Label ID="LabelId" ForeColor="Green" runat="server" Text='<%#Eval("Id") %>'  ToolTip='<%#Eval("Message") %>'></asp:Label></td>
                <td><asp:Label ID="LabelNumeroGsm" runat="server" Text='<%#Eval("NumeroGSM") %>'  ToolTip='<%#Eval("Message") %>'></asp:Label></td>
                <td><asp:Label ID="LabelMessage" ForeColor="Blue" runat="server" Text='<%#Eval("Message") %>' ToolTip='<%#Eval("Message") %>'></asp:Label></td>
                <td><asp:Label ID="LabelDateDemande" runat="server" Text='<%#Eval("DateDemande") %>'  ToolTip='<%#Eval("Message") %>'></asp:Label></td>
                <td><asp:Label ID="LabelDateEnvoi" ForeColor="Red" runat="server" Text='<%#Eval("DateEnvoi") %>'  ToolTip='<%#Eval("SmsStatut.Nom") %>'></asp:Label></td>
                <td><asp:Label ID="LabelProjet" ForeColor="Green" runat="server" Text='<%#Eval("Projet.Nom") %>'></asp:Label></td>
                <td><asp:Label ID="LabelStatut" ForeColor="Red" runat="server" Text='<%#Eval("SmsStatut.Nom") %>'></asp:Label></td>
            </tr>
         </ItemTemplate>
        <EmptyDataTemplate>
            <div align="center">            
